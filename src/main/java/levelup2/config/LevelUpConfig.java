...
public class LevelUpConfig {
    ...
    private static String[] netherOresDefault = {"oreQuartz,0xE5DED5,2,minecraft:quartz, Quartz", "oreCobalt,0x2979e7,4,tconstruct:ingots, Cobalt", "oreArdite,0xFFBD24,5,tconstruct:ingots:1, Ardite"};
